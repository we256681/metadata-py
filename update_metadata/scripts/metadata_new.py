...
"""
Metadata Management Script for Markdown Files

This script provides functionality to add, update, or remove metadata blocks
in markdown files. The metadata block is placed at the end of the file.
Enhanced with automatic author detection from Git and system.
Added support for bulk processing and ignore patterns.
"""
